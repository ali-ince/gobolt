...
func newDirectConnection(conn *neo4jConnector, mode AccessMode) (*neo4jConnection, error) {
...
func releaseDirectConnection(connection *neo4jConnection) error {
...
func (connection *neo4jConnection) Close() error {
	if err := releaseDirectConnection(connection); err != nil {
		return err
	}
	return nil
}
